...
class UpdateProductNameUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        useCase = new UpdateProductNameUseCase(productRepository, branchRepository, franchiseRepository);
    ...
    void updateName_validName_shouldReturnUpdatedProduct() {
        ...
        when(productRepository.existsByNameAndBranchId("New Name", 1L)).thenReturn(Mono.just(false));
        ...
        verify(productRepository).existsByNameAndBranchId("New Name", 1L);
    ...
    @Test
    void updateName_productNotFound_shouldReturnBusinessException() {
        when(franchiseRepository.findByIdFranchise(1L)).thenReturn(Mono.just(existingFranchise));
        when(branchRepository.findByIdAndFranchiseId(1L, 1L)).thenReturn(Mono.just(existingBranch));
    ...
    @Test
    void updateName_productNotBelongsToBranch_shouldReturnBusinessException() {
        when(franchiseRepository.findByIdFranchise(1L)).thenReturn(Mono.just(existingFranchise));
        when(branchRepository.findByIdAndFranchiseId(1L, 1L)).thenReturn(Mono.just(existingBranch));
    ...
    void updateName_duplicateName_shouldReturnBusinessException() {
        ...
        when(branchRepository.findByIdAndFranchiseId(1L, 1L)).thenReturn(Mono.just(existingBranch));
        when(productRepository.findByIdAndBranchId(1L, 1L)).thenReturn(Mono.just(existingProduct));
        when(productRepository.existsByNameAndBranchId("Duplicate Name", 1L)).thenReturn(Mono.just(true));
        ...
        verify(branchRepository).findByIdAndFranchiseId(1L, 1L);
        verify(productRepository).findByIdAndBranchId(1L, 1L);
        verify(productRepository).existsByNameAndBranchId("Duplicate Name", 1L);
        verify(productRepository, never()).saveProduct(any());
    }
    ...
    @Test
    void updateName_franchiseRepositoryError_shouldPropagateException() {
    ...
    @Test
    void updateName_branchRepositoryError_shouldPropagateException() {
        RuntimeException repositoryError = new RuntimeException("Database error");
        when(franchiseRepository.findByIdFranchise(1L)).thenReturn(Mono.just(existingFranchise));
    ...
    @Test
    void updateName_productFindRepositoryError_shouldPropagateException() {
        RuntimeException repositoryError = new RuntimeException("Database error");
        when(franchiseRepository.findByIdFranchise(1L)).thenReturn(Mono.just(existingFranchise));
        when(branchRepository.findByIdAndFranchiseId(1L, 1L)).thenReturn(Mono.just(existingBranch));
    ...
    @Test
    void updateName_productExistsRepositoryError_shouldPropagateException() {
        RuntimeException repositoryError = new RuntimeException("Database error");
        when(franchiseRepository.findByIdFranchise(1L)).thenReturn(Mono.just(existingFranchise));
        when(branchRepository.findByIdAndFranchiseId(1L, 1L)).thenReturn(Mono.just(existingBranch));
        when(productRepository.findByIdAndBranchId(1L, 1L)).thenReturn(Mono.just(existingProduct));
        when(productRepository.existsByNameAndBranchId("New Name", 1L)).thenReturn(Mono.error(repositoryError));
    ...
    @Test
    void updateName_saveRepositoryError_shouldPropagateException() {
