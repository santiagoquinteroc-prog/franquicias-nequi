...
- Levantar PostgreSql en el puerto `5432` de tu máquina (internamente `5432` en el contenedor)

Para detener y limpiar contenedores/volúmenes:
```bash
docker-compose -f deployment/docker-compose.yml down -v  n
```

### Ejecutar localmente (sin Docker para la app)

Si deseas ejecutar la aplicación **localmente** y usar Docker **solo para la base de datos PostgreSQL**:
